...
# lambda handler is mandatory event handler
def lambda_handler(event, context):
    ...
    try:
        # this is for queryStringParameters eg. https://<API_ID>.execute-api.<AWS_REGION>.amazonaws.com/<STAGE>/<LAMBDA_FUNC>?param1=hello?param2=world
