...
def getThankResponse(logger):
    try:
        filepath = f"D:\\Source\\Python\\buySolarFAQAgent\\InvokeAgent\\Modules\\General_Responses_Thank_v1.0.txt"
